...
std::vector<double> gslSolver_rk4( std::vector<double>&, double, int, std::string&);

std::vector<double> gslSolver_rk2( std::vector<double>&, double, int, std::string&);

std::vector<double> gslSolver_rkf45( std::vector<double>&, double, int, std::string&);
